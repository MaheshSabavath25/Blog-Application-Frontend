...
//       liked: Boolean(res.data.liked) // ✅ TRUST BACKEND
//     });
//   } catch (err) {
...
//   // ✅ FRONTEND FIX FOR LIKE PERSISTENCE
...
//           <FaSmile
//             onClick={() =>
//               setShowEmojiFor(prev => (prev === c.id ? null : c.id))
//             }
//           />
...
//         className="hashtag"
//         onClick={() =>
//           window.location.href = `/tag/${word.substring(1)}`
//         }
//       >
//         {word}{" "}
//       </span>
...
//           <FaSmile
//             onClick={() =>
//               setShowEmojiFor(prev => (prev === "comment" ? null : "comment"))
//             }
//           />
